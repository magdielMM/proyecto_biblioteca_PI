...
<body>
    ...
    <h1 class="my-7">Registrar Salida</h1>
        <table class="table-flex">
            <thead class="bg-black font-bolde">
                <tr>
                    <th class="px-4 py-2 text-center">Matrícula</th>
                    <th class="px-4 py-2 text-center">Servicio</th>
                    <th class="px-4 py-2 text-center">Hora Entrada</th>
                    <th class="px-4 py-2 text-center">Marcar Salida</th>
                </tr>
            </thead>
            <tbody>
                    ...
                    <tr>
                        ...
                        <td class="px-4 py-2">
                            <?php if (!empty($row['hora_salida'])) { ?>
                                <button type="button" class=" text-white font-bold py-2 px-4 rounded" onclick="registrarSalida(<?php echo $row['id_registro']; ?>)">Salida</button>
                            <?php } else { ?>
